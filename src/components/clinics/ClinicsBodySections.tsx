        ...
        content: (
          <div className="space-y-3">
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-3">
              ...
              <p className="text-sm text-gray-600">Wer wartet? Wer ist dran? Was ist nächster Schritt?</p>
            </div>
          </div>
        )
      },
        ...
        content: (
          <div className="space-y-3">
            <div className="rounded-lg border border-gray-200 bg-white p-4">
              ...
              <p className="text-sm text-gray-600">„Kurze Rückfrage: Soll ich dir zwei Terminvorschläge für diese Woche senden?“</p>
            </div>
            <div className="rounded-lg border border-gray-200 bg-white p-4">
  ...
  const faqs = useMemo(
    () => [
      ...
      },
      {
        ...
        a: "Wenn die Grundlagen (Formular, Zuständigkeiten, Nachrichten) klar sind, kann ein erster produktiver Ablauf sehr schnell stehen. In der Demo klären wir, was bei dir realistisch ist."
      },
      {
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="w-[90%] mx-auto bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 md:p-12">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-10">
              {[
                { title: "Antworten kommen zu spät", text: "Interessenten fragen bei mehreren Anbietern an. Wer nicht schnell antwortet, verliert." },
                { title: "Es gibt kein klares Follow-up", text: "Ohne feste Schritte wird „später“ schnell zu „nie“. Leads bleiben liegen." },
                { title: "Anfragen versanden im Alltag", text: "Telefon, Empfang, Teamwechsel, Rückfragen – am Ende fehlt die Übersicht." }
              ].map((item) => (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="w-[90%] mx-auto bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 md:p-12">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-gray-600 mt-4">
                Ein pragmatisches Lead-Conversion-System – sauber, verständlich und für den Klinikalltag gemacht.
              </p>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
              {[
                { title: "Sofort-Antwort auf neue Anfragen", text: "Automatische Bestätigung + nächster Schritt, damit niemand ins Leere fragt." },
                { title: "Klare Lead-Pipeline", text: "Eine Übersicht, die zeigt, wo jeder Lead steht – und was als nächstes passiert." },
                { title: "Automatische Follow-ups", text: "Strukturiertes Nachfassen, bis ein Termin steht – ohne dass das Team dran denken muss." },
                { title: "Termin-Erinnerungen", text: "Reduziert No-Shows und macht die Kommunikation für Patienten klar und ruhig." },
                { title: "Reaktivierung alter Leads", text: "Alte Anfragen sind oft die günstigsten Buchungen – wenn man sie sauber aktiviert." }
              ].map((item) => (
      ...
      <section className="px-4 py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="w-[90%] mx-auto bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 md:p-12">
            <div className="max-w-3xl">
              <h2 className="text-3xl md:text-4xl font-bold text-black">Für wen das gebaut ist</h2>
              <p className="text-lg text-gray-600 mt-4">
                Für Premium-Anbieter mit hochwertigen Leads – wo Geschwindigkeit, Vertrauen und saubere Kommunikation entscheiden.
              </p>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-10">
              {["Ästhetische Kliniken", "Laser-Kliniken", "Beauty / Cosmetic Clinics", "Premium Dental Clinics"].map((label) => (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="w-[90%] mx-auto bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 md:p-12">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-gray-600 mt-4">Kurz beantwortet – in der Demo klären wir, was bei dir konkret Sinn macht.</p>
            </div>
