...
import { validateNotificationRequest } from "../_shared/validation.ts";
...
serve(async (req: Request) => {
  ...
  try {
    ...
    const validationResult = validateNotificationRequest(requestData);
    ...
    const { to, subject, packageRequest } = validationResult.data!;
